      ...
      <div className="relative z-10 flex max-h-[88vh] w-full max-w-md flex-col rounded-t-[28px] bg-card shadow-elevated animate-slide-up">
        ...
        <div className="border-t border-border bg-card px-5 pb-6 pt-3">
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-2xl bg-gradient-primary px-5 py-3.5 text-sm font-bold text-primary-foreground shadow-glow-primary disabled:opacity-60"
          >
            {busy || accepting ? (
