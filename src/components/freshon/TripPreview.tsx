              ...
              kilometres actually go, including the ride to the hub. */}
                    ...
                    {trip.hub && (
                        <div className="mt-3 flex items-start gap-3 rounded-2xl bg-card p-3 ring-1 ring-border">
                            <div className="grid h-9 w-9 shrink-0 place-items-center rounded-xl bg-gradient-amber text-accent-foreground">
            ...
            full picture in view. */}
                <div className="border-t border-border bg-card px-5 pb-safe-6 pt-3">
                    <button
                        ...
                        className="flex w-full items-center justify-center gap-2 rounded-2xl bg-gradient-primary px-5 py-4 text-sm font-bold text-primary-foreground shadow-glow-primary transition active:scale-[0.99] disabled:opacity-60"
                    >
                        {busy || accepting ? (
