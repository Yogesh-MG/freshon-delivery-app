...
export const ProximityChip = ({ proximity }: { proximity: StopProximity }) => {
  if (proximity.awaitingFix) {
    return (
      <span className="mt-1 inline-flex items-center gap-1 rounded-md bg-muted px-1.5 py-0.5 text-[10px] font-bold text-muted-foreground">
  ...
  if (!proximity.unlocked) {
    return (
      <span className="mt-1 inline-flex items-center gap-1 rounded-md bg-muted px-1.5 py-0.5 text-[10px] font-bold tabular-nums text-muted-foreground">
  ...
  return (
    <span className="mt-1 inline-flex items-center gap-1 rounded-md bg-primary-soft px-1.5 py-0.5 text-[10px] font-bold tabular-nums text-primary">
