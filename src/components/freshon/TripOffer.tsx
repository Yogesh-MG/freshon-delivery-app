      ...
      <div className="px-5 py-5">
        {inRange ? (
          <button
            onClick={handleClaim}
            disabled={claiming}
            className="relative flex w-full items-center justify-center gap-2 overflow-hidden rounded-2xl bg-accent py-4 text-base font-extrabold text-accent-foreground disabled:opacity-80"
          >
            {claiming ? (
              <>
