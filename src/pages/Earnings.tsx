                            ...
                            <>
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    ...
                                    <SummaryCard
                                        ...
                                        trend="Lifetime"
                                        color={ratingColor(history.lifetime.rating)}
                                    />
                                    <SummaryCard
                                        icon={Package}
                                        label="Deliveries"
...
/** Rating tier → SummaryCard colour: green (good) → amber → red (poor). Out of 5. */
const ratingColor = (rating: number): "green" | "amber" | "red" =>
    rating >= 4.5 ? "green" : rating >= 3.5 ? "amber" : "red";
...
const SummaryCard = ({
    ...
    value: string;
    trend: string;
    color: "primary" | "amber" | "green" | "blue" | "red";
}) => {
    const colorClasses = {
